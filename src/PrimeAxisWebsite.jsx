    ...
    <div className="min-h-screen bg-slate-950 text-white">
              ...
              <div className="space-y-4">
                <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-4">
                  ...
                  <div className="mt-1 text-slate-200">
                    Automate customer support, internal operations, analytics,
                ...
                <div className="rounded-2xl border border-white/10 bg-slate-900/70 p-4">
                  ...
                  <div className="mt-1 text-slate-200">
                    Protect cloud, network, and application environments with
      ...
      <section id="services" className="mx-auto max-w-7xl px-6 py-16 md:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service) => (
            <div
              key={service.title}
              className="rounded-[24px] border border-white/10 bg-white/5 p-6 shadow-lg shadow-slate-950/30 transition hover:-translate-y-1 hover:border-cyan-400/30"
            >
      ...
      <section id="about" className="border-y border-white/10 bg-white/5">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-2 md:py-24">
          <div>
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              A modern IT partner with strong emphasis on AI and cyber resilience
            </h2>
          </div>
          <div className="space-y-4 text-slate-300 leading-7">
            <p>
              Prime Axis North America Limited delivers practical technology
              solutions for businesses that want to move faster without
              sacrificing security or quality.
            </p>
            <p>
              Our approach focuses on measurable business value through
              AI-powered automation, enterprise networking, cybersecurity
              hardening, software engineering, and quality assurance.
            </p>
            <p>
              We work with organizations that need thoughtful architecture,
              reliable delivery, and future-ready systems.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="why-us" className="mx-auto max-w-7xl px-6 py-16 md:py-24">
        <div className="mb-10 max-w-3xl">
          ...
          <h2 className="text-3xl font-bold md:text-4xl">
            What makes Prime Axis different
          </h2>
        </div>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              We design solutions that use AI where it creates real operational
              value, from intelligent agents to workflow automation and
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              Security is integrated from the start across infrastructure,
              applications, identity, and network architecture rather than
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-3 leading-7 text-slate-300">
              From planning and architecture to implementation, testing, and
              optimization, we support the full technology lifecycle.
            </p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-6">
            <h3 className="text-xl font-semibold">Scalable engineering</h3>
            <p className="mt-3 leading-7 text-slate-300">
              We build systems that are ready for growth, operationally sound,
              and aligned with modern enterprise expectations.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 max-w-xl leading-7 text-slate-300">
                ...
                networking, software development, or software testing, we’re
